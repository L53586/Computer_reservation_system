      ...
      <el-container>
        <el-main>
          <!-- <el-table :data="tableData">
            <el-table-column prop="date" label="教室" width="140">
            </el-table-column>

            <el-table-column prop="name" label="电脑数" width="140">
            </el-table-column>
             <el-table-column label="是否选中" type="selection">
            </el-table-column> -->
          <!-- <el-table-column
              label="选择"
              width="60px"
              ...
              header-align="center"
            >
            <button @click="choice_room">确认</button> -->
          <!--                        
          ...
          <el-table :data="tableData" @selection-change="handleSelectionChange"
            ...
            ></el-table-column>
            <el-table-column
              prop="roomaddress" label="教室地址"
              
              align="center"
            ></el-table-column>
            <el-table-column
             prop="pcnumber" label="电脑数量"
              align="center"
            ></el-table-column>
             <el-table-column
             prop="tag" label="是否空闲"
    ...
    deleteroom() {
     ...
     handleSelectionChange(val) {
      ...
      this.multipleSelection.map((item) => {
        //遍历数组，把id存进自定义的数组里
        this.batchPassArr.push(item.roomname);
      });
